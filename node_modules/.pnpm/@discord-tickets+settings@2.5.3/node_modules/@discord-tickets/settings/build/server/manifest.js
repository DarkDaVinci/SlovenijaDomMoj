...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/12-Ds908fXL.js')),
			__memo(() => import('./chunks/13-CmSZi0Ds.js')),
			__memo(() => import('./chunks/14-B6Wr0C1y.js')),
			__memo(() => import('./chunks/15-BjZjgD05.js')),
			__memo(() => import('./chunks/16-CUBU_QEd.js')),
			__memo(() => import('./chunks/17-CRCS3whQ.js')),
			__memo(() => import('./chunks/18-CTqP1i1l.js')),
			__memo(() => import('./chunks/19-V0Qiyv0f.js')),
			__memo(() => import('./chunks/20-BnsEv0Ut.js')),
			__memo(() => import('./chunks/21-BPZFiZFq.js')),
			__memo(() => import('./chunks/22-BfNpkxn-.js')),
			__memo(() => import('./chunks/23-BYi6nkeR.js'))
		],
		routes: [
			{
				id: "/(default)",
